...
echo "    <table class='table table-striped projects'>";
  ...
  $query_study_material = "SELECT * FROM `study_material` WHERE `study_material`.`study_material_class` = $student_std AND `study_material`.`study_material_board` = '$student_board' AND `study_material`.`study_material_subject` = $subject_id";
  $select_study_material = mysqli_query($connection,$query_study_material);
  while($study_material = mysqli_fetch_assoc($select_study_material)){
    
    // $total_marks_obtained = $study_material['student_marks'];
    // $total_marks = $study_material['total_marks'];
