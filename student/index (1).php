      ...
      <div class="row">
        <div class="column">
          <table>
            ...
            <tr>
              <td>1</td>
              <td>              <img src="images/medal.svg  " alt=""style="width: 30px;">Jill</td>
              <td>Smith</td>
              <td>50</td>
            </tr>
            <tr>
              ...
              <td><img src="images/medal2.svg  " alt=""style="width: 30px;">
            ...
            <tr>
              ...
              <td><img src="images/medal3.svg  " alt=""style="width: 30px;">
                Adam</td>
              <td>Johnson</td>
              <td>67</td>
            </tr>
            ...
            <tr>
              <td>4</td>
              <td><img src="images/star1.svg  " alt=""style="width: 30px;">
                Adam</td>
              <td>Johnson</td>
              <td>67</td>
            </tr>
              ...
              <tr >
                <td>
                  ...
                  <select style="margin-left: 400px;">
                    ...
                    <option value="saab">Maths</option>
                    <option value="opel">SS</option>
                    <option value="audi">English</option>
                  </select>
                </td>

                <td>
                  <button type="submit" name="show_list" class="btn btn-info float-left" style="margin-left: 100px;">Search</button>
                </td>
              </tr>
            </table>
          </form>
