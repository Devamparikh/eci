...
<head>
  ...
  <title>Attendance Manage | ECI</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="form-group">
      ...
      if (isset($_GET['delete'])) {
        # code...
        $attendance_entry_id = $_GET['delete'];
        $delete_query = "DELETE FROM `attendance_entry` WHERE `attendance_entry_id` = $attendance_entry_id";
        $delete = mysqli_query($connection,$delete_query);
        $delete_query = "DELETE FROM `attendance` WHERE `attendance_entry_id` = $attendance_entry_id";
        $delete = mysqli_query($connection,$delete_query);
...
<button type="submit" name="search" class="btn btn-info float">Search</button>
          ...
          <table class="table table-striped projects">
              ...
              if(isset($_POST['search'])){
                ...
                $i=1;
$query_attendance_table = "SELECT * FROM `attendance_entry` WHERE `attendance_entry`.`student_std` = $class_number AND `attendance_entry`.`student_subject` = $subject_id AND `attendance_entry`.`student_board` LIKE '$board_name' ORDER BY `attendance_entry_id` DESC";
$select_attendance_entry = mysqli_query($connection,$query_attendance_table);
while ($attendance = mysqli_fetch_assoc($select_attendance_entry)) {
  $attendance_entry_id  = $attendance['attendance_entry_id'];
...
//   $filename = $file['filename'];
                ...
                //   echo"</td>";
                  echo"<td>";
                  echo" <a href='attendance_manage.php?delete=$attendance_entry_id' class='btn btn-danger'>Delete</a>";
                  echo"</td> ";
                  echo"</tr>";
