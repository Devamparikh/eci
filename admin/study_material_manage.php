...
<head>
  ...
  <title>Study Material Manage | ECI</title>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="form-group">
      <button style="text-align:left" type="submit" href="add-new-students.php" class="btn btn-primary">Upload New Book</button>               
    </div>
      <!-- Default box -->
      <div class="card">
      <?php
      ...
      if (isset($_GET['delete'])) {
        # code...
        $study_material_id = $_GET['delete'];
        $delete_query = "DELETE FROM `study_material` WHERE `study_material_id` = $study_material_id";
...
<button type="submit" name="search" class="btn btn-info float">Search</button>
          ...
          <table class="table table-striped projects">
              ...
              if(isset($_POST['search'])){
                ...
                $i=1;
$query_study_material_table = "SELECT * FROM `study_material` WHERE `study_material`.`study_material_class` = $class_number AND `study_material`.`study_material_board` LIKE '$board_name' AND `study_material`.`study_material_subject` = $subject_id ORDER BY `study_material_id` DESC";
$select_study_material = mysqli_query($connection,$query_study_material_table);
while ($study_material = mysqli_fetch_assoc($select_study_material)) {
  $study_material_id = $study_material['study_material_id'];
  $study_material_desc = $study_material['study_material_desc'];
  $time_stamp = $study_material['time_stamp'];
  $filename = $study_material['filename'];
//   $study_material_id = $study_material['study_material_id'];
...
//   $filename = $file['filename'];
                ...
                //   echo"</td>";
                  echo"<td>";
                  echo" <a href='study_material_manage.php?delete=$study_material_id' class='btn btn-danger'>Delete</a>";
                  echo"</td> ";
                  echo"</tr>";
