...
<button type="submit" name="search" class="btn btn-info float">Search</button>
          ...
          <table class="table table-striped projects">
              ...
              if(isset($_POST['search'])){
                ...
                $i=1;
$query_student_enter = "SELECT * FROM `student` WHERE `student`.`student_std` = $class_number AND `student`.`student_board` LIKE '$board_name'";
$select_student_enter = mysqli_query($connection,$query_student_enter);
while ($student = mysqli_fetch_assoc($select_student_enter)) {
  ...
  $student_contact = $student['student_contact'];
                  ...
                  echo"</td>";
                  echo"<td>";
                  echo"  <a href='blank.php?student_id=$student_id'>";
                  echo"     $student_roll";
                  echo"   </a>";
                  echo" </td>";
                  echo" <td>";
                  ...
                  echo" <a href='fees.php?fee=$student_id' class='btn btn-danger'>Check Fee</a>";
                  echo"</td> ";
                  echo"<td>";
                  ...
                  echo"</td>";
                  echo"<td>";
                  echo" <a href='students.php?delete=$student_id' class='btn btn-danger'>Delete</a>";
                  echo"</td> ";
                  echo"</tr>";
