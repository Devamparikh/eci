...
<head>
  ...
  <title>Fee Popup Manage | ECI</title>
      ...
      ?>
        ...
        <form role="form" action="" method = "post">              
          ...
          <table class="table table-striped projects">
              ...
              <?php
                $i=1;
$query_popup = "SELECT * FROM `popup` WHERE `popup`.`class_number` = 0 ORDER BY `popup_id` DESC";
$select_popup = mysqli_query($connection,$query_popup);
while ($popup_fetch = mysqli_fetch_assoc($select_popup)) {
  $popup_id  = $popup_fetch['popup_id'];
  $subject_id  = $popup_fetch['subject_id'];
  $board_name  = $popup_fetch['board_name'];
  $popup_msg  = $popup_fetch['popup_msg'];
  $publish_date  = $popup_fetch['publish_date'];
  $time_stamp  = $popup_fetch['time_stamp'];
                ...
                //   echo"</td> ";
                  echo"<td>";
                  echo" <a href='fee_popup_manage.php?delete=$popup_id' class='btn btn-danger'>Delete</a>";
                  echo"</td> ";
                  echo"</tr>";
