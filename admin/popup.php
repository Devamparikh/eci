...
?>
  ...
  <div class="content-wrapper">
    ...
    <script>
        $(document).ready(function(){
            $("select.class").change(function(){
                window.class_number = $(this).children("option:selected").val();
            });
            $("select.board").change(function(){
                window.board_name = $(this).children("option:selected").val();
            });
            $("select.subject").change(function(){
                window.subject_id = $(this).children("option:selected").val();
            });
            $("button.get_students").click(function(){
                $("#student_option").load("load_student_option.php",{
                    class_number_value: window.class_number,
                    board_name_value: window.board_name,
                    subject_id_value: window.subject_id
                });
            });
        });
    </script>
    <section class="content">
        ...
        if(isset($_POST['submit'])){
         ...
         echo $student_roll = $_POST['student'];
          $popup_msg = $_POST['popup_msg'];
        //   $assignment = mysqli_real_escape_string( $connection,urlencode($assignment) ); 
          $publish_date = $_POST['publish_date'];
    // header("Location: 500.php?uploadsuccess");

    $popup_query = "INSERT INTO `popup` (`popup_id`, `class_number`, `subject_id`, `board_name`, `student_roll`, `popup_msg`, `publish_date`, `time_stamp`) VALUES (NULL, $class_number, $subject_id, '$board_name', '$student_roll', '$popup_msg', '$publish_date', now())";
    $insert_popup_data = mysqli_query($connection,$popup_query);
    if(!$insert_popup_data){
          ...
          <div class="col-md-14">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Compose New Pop Up Message</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  <tr>
    <td>
      <select class="class form-control select2" name="class" style="width: 100%;">
...
?>
    ...
    <td>
      <select class="board form-control select2" name="board" style="width: 100%;">
    <option disabled selected value> -- select an option -- </option>
      <?php
...
?>
    ...
    <td>
    <select class="subject form-control select2" name="subject" style="width: 100%;">
    <option disabled selected value> -- select an option -- </option>
    <?php
...
?>
    ...
    <td id="student_option">
    <button type="button" class="get_students">Get Students</button>
    </td>
  </tr>
</table>
                  <hr>
                <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 300px" name="popup_msg">
                ...
                <div class="form-group">
                  <label for="ending_time" class="btn btn-flat" style="align-items: right">Publish Date : </label>
