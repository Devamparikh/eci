  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        if(isset($_POST['submit'])){
          ...
          $class_number = 0;
          $subject_id = $_POST['installments'];
          $board_name = $_POST['fee_destribution'];
          $student_roll = "";
          ...
          <div class="col-md-14">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Compose New Fee Pop Up Message</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
