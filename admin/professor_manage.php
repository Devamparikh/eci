...
<head>
  ...
  <title>Professor Manage | ECI</title>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="form-group">
      <button style="text-align:left" type="submit" href="add_professor.php" class="btn btn-primary">Add New Professor</button>               
    </div>
      <!-- Default box -->
      <div class="card">
      <?php
      ...
      if (isset($_GET['delete'])) {
        # code...
        $professor_id = $_GET['delete'];
        $delete_query = "DELETE FROM `professor` WHERE `professor_id` = $professor_id";
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <?php
                ...
                $i=1;
$query_professor_enter = "SELECT * FROM `professor` ORDER BY `professor_id` DESC";
$select_professor_enter = mysqli_query($connection,$query_professor_enter);
while ($professor_fetch = mysqli_fetch_assoc($select_professor_enter)) {
  $professor_id = $professor_fetch['professor_id'];
  $professor_username = $professor_fetch['professor_username'];
  $professor_name = $professor_fetch['professor_name'];
  $professor_contact = $professor_fetch['professor_contact'];
                  ...
                  echo"</td>";
                  echo"<td>";
                  echo"  <a href='blank.php?student_id=$professor_id'>";
                  echo"     $professor_username";
                  echo"   </a>";
                  echo" </td>";
                  echo" <td>";
                  echo"     <a>";
                  ...
                  echo"    <td>";
                  echo"   <a>";
                  echo"       $professor_contact";
                  echo"   </a>";
                  echo"</td>               "; 
                  echo" <td>";
                  echo"     <a>";
                  $query_select_class = "SELECT * FROM `professor`,`professor_given_class` WHERE `professor`.`professor_id`=`professor_given_class`.`professor_id` AND `professor`.`professor_id` = $professor_id";
                  $select_class = mysqli_query($connection,$query_select_class);
                  ...
                  echo" <td>";
                  echo"     <a>";
                  $query_select_board = "SELECT * FROM `professor`,`professor_given_board` WHERE `professor`.`professor_id`=`professor_given_board`.`professor_id` AND `professor`.`professor_id` = $professor_id";
                  $select_board = mysqli_query($connection,$query_select_board);
                  ...
                  echo" <td>";
                  echo"     <a>";
                  $query_select_subject = "SELECT * FROM `professor`,`professor_given_subject` WHERE `professor`.`professor_id`=`professor_given_subject`.`professor_id` AND `professor`.`professor_id` = $professor_id";
                  ...
                  // echo"</form>";
                  echo"<td>";
                  echo"<a href='add_professor.php?edit=$professor_id' class='btn btn-primary'>Edit</a>";
                  echo"</td>";
                  echo"<td>";
                  echo" <a href='professor_manage.php?delete=$professor_id' class='btn btn-danger'>Delete</a>";
                  echo"</td> ";
                  echo"</tr>";
