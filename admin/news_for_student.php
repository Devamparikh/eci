...
<head>
  ...
  <title>News For Students | ECI</title>
...
?>
  ...
  <div class="content-wrapper">
    ...
    $news_query = "INSERT INTO `news_for_student` (`class_number`, `subject_id`, `board_name`, `student_roll`, `assignment`, `publish_date`, `time_stamp`) VALUES ($class_number, $subject_id, '$board_name', '$student_roll', '$assignment', '$publish_date', now())";
    $insert_news_data = mysqli_query($connection,$news_query);
    if(!$insert_news_data){
          ...
          <div class="col-md-14">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Compose New News Message</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
