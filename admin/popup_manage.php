...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="form-group">
      <button style="text-align:left" type="submit" href="add-new-students.php" class="btn btn-primary">Add New Pop Up</button>               
    </div>
      <!-- Default box -->
      <div class="card">
      <?php
      ...
      if (isset($_GET['delete'])) {
        # code...
        $popup_id = $_GET['delete'];
        $delete_query = "DELETE FROM `popup` WHERE `popup_id` = $popup_id";
...
<button type="submit" name="search" class="btn btn-info float">Search</button>
          ...
          <table class="table table-striped projects">
              ...
              if(isset($_POST['search'])){
                ...
                $i=1;
$query_popup_table = "SELECT * FROM `popup` WHERE `popup`.`class_number` = $class_number AND `popup`.`subject_id` = $subject_id AND `popup`.`board_name` LIKE '$board_name' ORDER BY `popup_id` DESC";
$select_popup = mysqli_query($connection,$query_popup_table);
while ($popup_row = mysqli_fetch_assoc($select_popup)) {
  $popup_id  = $popup_row['popup_id'];
  $student_roll  = $popup_row['student_roll'];
  $popup_msg  = $popup_row['popup_msg'];
  $publish_date  = $popup_row['publish_date'];
  $time_stamp  = $popup_row['time_stamp'];
...
//   $filename = $file['filename'];
                ...
                //   echo"</td>";
                  echo"<td>";
                  echo" <a href='popup_manage.php?delete=$popup_id' class='btn btn-danger'>Delete</a>";
                  echo"</td> ";
                  echo"</tr>";
