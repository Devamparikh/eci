  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="Exam/createExam.php" class="nav-link">
              <i class="nav-icon fas fa-sign-out-alt" style='font-size:22px'></i>
              <p>
                Create Exam
              </p>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Test Link</h1>
          </div>
                <!-- Main content -->
...
if(isset($_POST['add_link'])){
  ...
  $link_close = $_POST['link_close'];
  $link_start = $_POST['link_start'];
  // $link_start = date("H:i:s" , strtotime('+ ' . $link_start . 'hours'));
  // $link_close = date("H:i:s" , strtotime('+ ' . $link_close . 'hours'));

  $link_url = mysqli_real_escape_string( $connection,urlencode($link_url) ); 

$query_link = "INSERT INTO `add_link` (`link_id`, `class_number`, `subject_id`, `board_name`, `link_url`, `link_desc`, `time_stamp`, `link_start`, `link_close`) VALUES (NULL, $class_number, $subject_id, '$board_name', '$link_url', '$link_desc', now(), '$link_start', '$link_close')";
$insert_link = mysqli_query($connection,$query_link);
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">To add link</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
...
?>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="Year" name="link_url" placeholder="Enter Year of Paper">
                                </div>
                                <div class="form-group">
                                  <label for="">Link Description</label>
                                  <input type="text" class="form-control" id="number" name="link_desc" placeholder="Enter Exam Type">
                                </div>  
                                <div class="form-group">
                                  <label for="">Start after hours:</label>
                                  <input type="datetime-local" class="form-control" id="number" name="link_start" placeholder="Enter Exam Type">
                                  <!-- <input type="text" class="form-control" id="number" name="link_start" placeholder="Enter Exam Type"> -->
                                </div>        
                                <div class="form-group">
                                  <label for="">Close after hours:</label>
                                  <input type="datetime-local" class="form-control" id="number" name="link_close" placeholder="Enter Exam Type">
                                  <!-- <input type="text" class="form-control" id="number" name="link_close" placeholder="Enter Exam Type"> -->
                                </div>                                      
                                      <br>
                               
                                <div class="card" align='center'>
                                    <button type="submit" class="btn btn-warning" name="add_link">Submit</button>
                                </div>
                              </div>
                            <!-- </form> -->
                            </div>
