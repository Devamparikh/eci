...
<head>
  ...
  <title>Previous Question Paper | ECI </title>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a href="add_ques_paper.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Upload Question Paper</h1>
          </div>
                <!-- Main content -->
...
if(isset($_POST['add_link'])){
  ...
  $link_url = mysql_real_escape_string( urlencode($link_url) ); 

$query_link = "INSERT INTO `add_link` (`link_id`, `link_url`, `link_desc`, `time_stamp`) VALUES (NULL, '$link_url', '$link_desc', now())";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">To upload question paper</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
