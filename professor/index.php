...
session_start();
if(isset($_GET['login'])){
  echo $professor_username = $_GET['login'];
   echo $_SESSION['professor_username'] = $_GET['login'];
}else{
  header("Location: 404.php");
} -->
  ...
  <aside class="main-sidebar sidebar-dark-warning elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="ChatApp/users.php" class="d-block">Admin Name</a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><a href='attendance.php'>Attendance</a>Attendance</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
...
if(isset($_POST['proceed'])){
 ...
 if(!empty($_POST['present'])){
    ...
    for($j=0; $j<$total_row; $j++){
      if(!empty($present_student_name[$j])){
        if(!empty($late_student_name[$j])){
          $late = 1;
        }else{
          $late = 0;
        }
