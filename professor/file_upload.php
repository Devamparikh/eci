  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="file_upload.php" class="nav-link active">
          <i class="nav-icon fas fa-chalkboard-teacher" style='font-size:21px'></i>
            <p>
              File Upload
            </p>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Worksheet/Assignment Upload</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <?php
if(isset($_POST['uploadfile'])){
  ...
  $upload_file = "INSERT INTO `file_upload` (`file_for_class`, `file_for_board`, `file_for_subject`, `chap_number`,`chap_name`,`brief_info`,`filename`,`time_stamp`) VALUES ($class_number, '$board_name', $subject_id, '$chap_number','$chap_name','$brief_info', '$fileNameNew',now())";
...
?>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="chap_number" name="chap_number" placeholder="Enter Chapter Number">
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputnumbeer">Chapter Name</label>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="brief_info" name="brief_info" placeholder="Enter Brief Information">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="card" align='center'>
                                    <button type="submit" class="btn btn-warning" name="uploadfile">Upload</button>
                                </div>
                              </div>
                            </form>
                            </div>
