...
<head>
  ...
  <title>Uploaded File Manager | ECI</title>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="form-group">
      <button style="text-align:left" type="submit" href="add-new-students.php" class="btn btn-primary">Upload New File</button>               
    </div>
      <!-- Default box -->
      <div class="card">
      <?php
      ...
      if (isset($_GET['delete'])) {
        # code...
        $file_id = $_GET['delete'];
        $delete_query = "DELETE FROM `file_upload` WHERE `file_upload_id` = $file_id";
...
<button type="submit" name="search" class="btn btn-info float">Search</button>
          ...
          <table class="table table-striped projects">
              ...
              if(isset($_POST['search'])){
                ...
                $i=1;
$query_file_table = "SELECT * FROM `file_upload` WHERE `file_upload`.`file_for_class`= $class_number AND `file_upload`.`file_for_board` = '$board_name' AND `file_upload`.`file_for_subject`= $subject_id ORDER BY `file_upload_id` DESC";
$select_file = mysqli_query($connection,$query_file_table);
while ($file = mysqli_fetch_assoc($select_file)) {
  ...
  $filename = $file['filename'];
                ...
                //   echo"</td>";
                  echo"<td>";
                  echo" <a href='file_upload_manage.php?delete=$file_id' class='btn btn-danger'>Delete</a>";
                  echo"</td> ";
                  echo"</tr>";
