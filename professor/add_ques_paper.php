                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-warning">
                            ...
                            if(isset($_POST['upload'])){
                              ...
                              $upload_ques_paper = "INSERT INTO `ques_paper` (`class_number`, `subject_id`, `board_name`, `paper_year`,`paper_type`,`filename`,`timestamp`) VALUES ($class_number, $subject_id, '$board_name', $paper_year,'$paper_type', '$fileNameNew',now())";
                              $insert_file = mysqli_query($connection,$upload_ques_paper);
                              }else{
...
?>
                                ...
                                <div class="form-group">
                                  <label>Year</label>
                                  <input type="number" class="form-control" id="Year" name="paper_year" placeholder="Enter Year of Paper">
                                </div>
                                <div class="form-group">
                                  <label for="">Exam Type</label>
                                  <input type="text" class="form-control" id="number" name="paper_type" placeholder="Enter Exam Type">
                                </div>
                                <div class="form-group">
